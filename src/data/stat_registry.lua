...
StatRegistry.defs = {
    ...
    rate_of_fire = { default = 1.0, group = "weapon", accepted_ops = { "flat", "add_pct", "mul", "override" }, clamp = { min = 0.01 } },
    shoot_cooldown = { default = 1.0, group = "weapon", accepted_ops = { "flat", "add_pct", "mul", "override" }, clamp = { min = 0 } },
