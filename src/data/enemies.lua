...
EnemyData.types = {
    bandit = {
        ...
        hp = 22,
        damage = 8,
        contact_attack_id = "atk_bandit_melee",
        defense = {},
        speed = 168,
        xpValue = 12,
        goldValue = 5,
    ...
    gunslinger = {
        ...
        hp = 50,
        damage = 8,
        ranged_attack_id = "atk_gunslinger_shot",
        defense = {},
        speed = 40,
        xpValue = 25,
        goldValue = 15,
    ...
    buzzard = {
        ...
        hp = 20,
        damage = 8,
        contact_attack_id = "atk_buzzard_contact",
        defense = {},
        speed = 150,
        xpValue = 10,
        goldValue = 3,
    ...
    necromancer = {
        ...
        hp = 44,
        damage = 10,
        ranged_attack_id = "atk_necromancer_shot",
        defense = {},
        speed = 34,
        xpValue = 30,
        goldValue = 18,
    ...
    nightborne = {
        ...
        hp = 28,
        damage = 10,
        contact_attack_id = "atk_nightborne_melee",
        defense = {},
        speed = 190,
        xpValue = 16,
        goldValue = 8,
    ...
    ogreboss = {
        ...
        hp = 280,
        damage = 18,
        contact_attack_id = "atk_ogreboss_melee",
        defense = { armor = 4 },
        speed = 116,
        xpValue = 110,
        goldValue = 70,
    ...
    blackkid = {
        ...
        hp = 220,
        damage = 14,
        contact_attack_id = "atk_blackkid_melee",
        defense = { armor = 2 },
        speed = 140,
        xpValue = 80,
        goldValue = 45,
