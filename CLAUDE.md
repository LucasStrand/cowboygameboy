...
`main.lua` renders to a fixed 1280×720 canvas then scales to the window. The parallax background scrolls at 30% camera speed. All graphics are procedural shapes (no sprite sheets); audio is placeholder.
